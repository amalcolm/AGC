...
class C3Pot : public CDigiPot {
  ...
  public:
    ...
    static constexpr int DIGIPOT_MAX_FOR_PHOTODIODE = 255; // Photodiode has max of 0.6v whereas pots have max of 3.3v, hence max for top is (CAutoPot::POT_MAX * 0.6 / 3.3); around 48;
