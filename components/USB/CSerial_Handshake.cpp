...
void CSerialWrapper::writeHandshakeResponse() {
  ...
  snprintf(buffer, sizeof(buffer)-1,
   "<DEVICE_VERSION=%s::STATE_DURATION_uS=%lf::HEAD_SETTLE_TIME_uS=%lf::POT_UPDATE_OFFSET_uS=%lf::A2D_SAMPLING_SPEED_Hz=%lf::A2D_READING_PERIOD_uS=%lf::A2D_QUIET_PERIOD_uS=%lf::MAX_BLOCKSIZE=%lu::MAX_EVENTS_PER_BLOCK=%lu\n",
    CFG::DEVICE_VERSION,
                   CFG::STATE_DURATION_uS,CFG::HEAD_SETTLE_TIME_uS,CFG::POT_UPDATE_OFFSET_uS,CFG::A2D_SAMPLING_SPEED_Hz,CFG::A2D_READING_PERIOD_uS,CFG::A2D_QUIET_PERIOD_uS,CFG::MAX_BLOCKSIZE,CFG::MAX_EVENTS_PER_BLOCK      );
