...
void CSerialWrapper::writeHandshakeResponse() {
  ...
  snprintf(buffer, sizeof(buffer)-1,
   "<DEVICE_VERSION=%s::STATE_DURATION_uS=%lu::HEAD_SETTLE_TIME_uS=%lu::POT_UPDATE_OFFSET_uS=%lu::A2D_SAMPLING_SPEED_Hz=%lu::A2D_READING_PERIOD_uS=%lu::MAX_BLOCKSIZE=%lu::MAX_EVENTS_PER_BLOCK=%lu\n",
    CFG::DEVICE_VERSION,
