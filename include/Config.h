...
public:
    ...
    inline static constexpr uint32_t STATE_DURATION_uS       =  10'500;  // time for each state. loop will be slightly longer than this

    inline static constexpr uint32_t HEAD_SETTLE_TIME_uS     =    400;  // delay between Head change and first A2D read
